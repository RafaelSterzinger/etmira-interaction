...
LINE_MEAN = 6.193796179409363
LINE_STD = 1.4917238625381812
MAX_AREA_TO_REMOVE = 0.15

A = 49.12884764154485
FLOC = -4.2788432450867955
SCALE = 0.21316680159573143
DIST = stats.gamma(a=A, loc=FLOC, scale=SCALE)
